                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="/hobby/{{ $hobby->id }}">
                            ...
                            <input class="btn btn-primary mt-4" type="submit" value="Edit Hobby">
                            </form>
                            <a class="btn btn-primary float-right mt-2" href="/hobby"><i class="fas fa-arrow-circle-up"></i> Back</a>
